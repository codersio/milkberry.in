                ...
                <div class="col-md-4 " style="background: white;padding: 2rem">
                    <form action="{{ url('admin/subcategory') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder=" sub category name" name="sub_title">
                        ...
                        <div class="form-group">
                            <select name=" product_type_id" id="" class="form-control">
                                ...
                                @foreach ($type as $key => $cat)
                                    <option value="{{ $cat->id }}">{{ $cat->type_title }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        @forelse ($categories as $key=> $category)
                            <tr>
                                ...
                                <td>
                                    ...
                                    |
                                    <a href={{ url('admin/delete', $category->id) }} class=" ">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('admin/subcategory-update', $category->id) }}"
                                                  method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group">
                                                    <input type="text" class="form-control"
                                                           value={{ $category->sub_title }} placeholder="category name"
                                                    name="sub_title">
                                                ...
                                                <div class="form-group">
                                                    <select name="product_type_id" id="" class="form-control">
                                                        <option value="">Select</option>
                                                        @foreach ($type as $cat)
                                                            <option value="{{ $cat->id }}"  {{ $category->product_type_id == $cat->id ? 'selected' : '' }}>
                                                                {{ $cat->type_title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
