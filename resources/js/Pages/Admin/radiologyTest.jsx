...
const RadioLogyTest = ({ admin, medicineCategories, medicine }) => {
    ...
    const pathologyTestList = async () => {
        try {
            const response = await axios.post('/api/admin/radiology-test-list');
    ...
    const createOpd = async (e) => {
        ...
        try {
            ...
            await axios.post('/api/admin/radiology-test-store', formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            });
