...
const Pathology = ({ admin, doctor }) => {
  ...
  const pathologybillfetch = async () => {
    try {
      const response = await axios.post('/api/admin/pathology-fetch-bill');
  ...
  const createOpd = async (e) => {
    ...
    try {
      ...
      await axios.post('/api/admin/pathology-store-bill', formData);
          ...
          <div className="card mt-2">
            <div className="card-header flex justify-between px-[3rem] border py-3">
              ...
              .<div className='flex space-x-3'>
                ...
                <Link href='/admin/pathology/test' className="bg-gray-700 p-2 text-white rounded-md flex space-x-2">
                  <div className='grid place-items-center mt-1'>
                    <FaPlus />
                  </div>
