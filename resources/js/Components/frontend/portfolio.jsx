            ...
            <div className="row m-0 portfolio-container ">
                <div className="col-lg-4 col-md-6 p-0 portfolio-item">
                    <div className="position-relative overflow-hidden">
                        <img className="img-fluid w-100" src="https://demo.htmlcodex.com/1362/ice-cream-shop-website-template/img/portfolio-1.jpg" alt="" />
                        <a className="portfolio-btn" href="img/portfolio-1.jpg" data-lightbox="portfolio">
                            <i className="fa fa-plus text-primary" style={{ fontSize: '60px' }} />
                        </a>
                    </div>
                </div>
                <div className="col-lg-4 col-md-6 p-0 portfolio-item">
                    <div className="position-relative overflow-hidden">
                        <img className="img-fluid w-100" src="https://demo.htmlcodex.com/1362/ice-cream-shop-website-template/img/portfolio-2.jpg" alt="" />
                ...
                <div className="col-lg-4 col-md-6 p-0 portfolio-item">
                    <div className="position-relative overflow-hidden">
                        <img className="img-fluid w-100" src="https://demo.htmlcodex.com/1362/ice-cream-shop-website-template/img/portfolio-3.jpg" alt="" />
                ...
                <div className="col-lg-4 col-md-6 p-0 portfolio-item">
                    <div className="position-relative overflow-hidden">
                        <img className="img-fluid w-100" src="https://demo.htmlcodex.com/1362/ice-cream-shop-website-template/img/portfolio-4.jpg" alt="" />
